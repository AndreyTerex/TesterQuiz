...
public class TestServiceTest {
    ...
    class AddQuestionTests {
        ...
        void addQuestion() {
            ...
            assertEquals(questionDTO.getQuestion_text(), result.getQuestions().get(0).getQuestion_text());
            assertEquals(1, result.getQuestions().get(0).getQuestion_number());
        }
    }
    ...
    class UpdateQuestionTests {
        ...
        void updateQuestion() {
            ...
            // ASSERT
            assertEquals("New question text is long enough", result.getQuestions().get(0).getQuestion_text());
            assertEquals(1, result.getQuestions().get(0).getAnswers().size());
            assertEquals("Correct Answer", result.getQuestions().get(0).getAnswers().get(0).getAnswer_text());
            verify(testDao).findById(testId);
